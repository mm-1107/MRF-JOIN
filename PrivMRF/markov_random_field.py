...
class MarkovRandomField:
    def __init__(self, data, domain, graph, measure_list, attr_list, \
        ...
        self.config['norm_query_number'] = 50
        print('### Important param k:', self.config['norm_query_number'], ", t:", self.config['t'], "###")
    ...
    def improve_attribute_level_for_data_domain(self):
        ...
        print(f'[Debug] self.domain.dict={self.domain.dict}')
    ...
    def belief_propagation(self, potential):
        ...
        for clique in self.maximal_cliques:
            ...
            # print("clique =", clique, "belief[clique] =", belief[clique])
    ...
    def synthetic_data(self, path):
        ...
        if len(self.maximal_cliques) == 1:
            print("Debug", self.maximal_cliques)
            cond_attr = []
    ...
    def pandas_generate_cond_column_data(self, clique_factor, cond, target):
        ...
        if len(cond) == 0:
            ...
            # print(f"attr_list={attr_list}, self.domain.attr_list={self.domain.attr_list}")
